...
const minSpread = 0.00000015;
const avgSpreadLimiter = 0.00000015;
...
let avgHigh = [];
let avgLow = [];
const currency = 'XRPBTC';
const mainCurrency = 'BTC';
const secCurrency = 'XRP';
const cstMaxToCancelBuy = 0.00000010;
const cstStopLossStart = -0.00000005;
const cstStopLossEnd = -0.0000100;
const cstRelistSell = -0.00000002;
...
function makeBuyOrder(bid, spd) {
  const buyPrice = parseFloat(bid) + parseFloat(0.00000000),
    sellPrice = parseFloat(buyPrice) + parseFloat(spd) - parseFloat(0.0000000);
